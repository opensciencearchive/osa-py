...
class TestOsaMeta:
    ...
    def test_meta_outputs_manifest_json(self) -> None:
        ...
        from osa.cli._runtime_commands import meta_command
...
class TestOsaEmit:
    def test_emit_writes_single_object(self, tmp_path) -> None:
        from osa.cli._runtime_commands import emit_command
...
class TestOsaProgress:
    def test_progress_appends_jsonl(self, tmp_path) -> None:
        from osa.cli._runtime_commands import progress_command
...
class TestOsaReject:
    def test_reject_writes_rejection(self, tmp_path) -> None:
        from osa.cli._runtime_commands import reject_command
